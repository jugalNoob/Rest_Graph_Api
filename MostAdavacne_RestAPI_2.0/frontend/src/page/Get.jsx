...
const PaginatedList = () => {
  ...
  let query = `http://localhost:9000/v2/DataGet?page=${page}&limit=${limit}&names=${name}&countrys=${country}&hoobies=${hobby}&removes=${remove}&truess=${eligible}&lesses=${less}&agegreats=${great}&pricegreat=${priceg}&priceless=${pricel}`;
